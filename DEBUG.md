...
| App | Taskbar | URL | display-mode | Title |
|-----|---------|-----|---|---|
| **SPX Service Point** | icon thứ 2 (X đỏ) | `https://sp.spx.shopee.vn/` | **`minimal-ui`** | "SPX Service Point" |
| **KiotVit** | icon thứ 5 (vàng) | `http://localhost:9009/` | `standalone` | "Kiot Vịt" |
